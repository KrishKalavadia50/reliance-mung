...
function Til() {
  ...
  const content = {
    gu: {
      ...
      SubTitle: "તલ ગુજરાત-1,2,3,4,5,6, 10,માણેક, રુદ્રક્ષ, એમ્બર, અલ્ટો સર્ટિફાઇડ, ફાઉન્ડેશન, ટ્રૂથફુલ",
      CompanyName: "રિલાયન્સ સીડ (પ્રો.) કંપની",
      address:" સરનામું: ગિંગાણી રોડ તિરુપતિ બાયપાસ, પાછળ સુભ હોન્ડા। જામાજોધપુર, જીલ્લો। જામનગર (ગુજરાત)",
    ...
    hi: {
      ...
      address:" पता: गिंगानी रोड तिरुपति बाईपास, पीछे सुभ होंडा। जमाजोधपुर, जिला। जामनगर (गुजरात)",
